...
export const VEHICLE_DATA = [
    {
        title: '2023 voyah free ultra long range REEV #94454558',
        image: '/vehicle-data/voyah.jpg',
        price: '100',
        discount: '95',
    },
    {
...
export const VALUES_DATA = [
    ...
    },
    {
        ...
        subtitle: '23 years okus experience on hand has made it possible for us to serve you exceptionally'
    },
    {
        icon: "",
        title: "Registered & Global",
        subtitle: 'Is a registered Trade Mark. We have showrooms in Dubai an Belgium'
    },
    {
        icon: "",
        title: "Trusted & Friendky",
...
export const USEFUL_LINKS = [
    ...
    {
        title: 'PPOPULAR VEHICLES WE SUPPLY',
        links: [
            {
                label: 'RHD Toyota Hilux for sale',
                url:''
            },
            {
                label: 'LHD Toyota Hilux for sale',
                url:''
            },
            {
